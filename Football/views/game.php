<table class="table">
 ...
 <tr class="active">
  <td><?=$game['date']?></td>
  <td><a href="/Football/index.php/Soccer/team/<?=$game['teams'][0]?>"><?=$team_names[$game['teams'][0]]?></a></td>
  <td><?=$goalsCounts[0]?> - <?=$goalsCounts[1]?></td>
  <td><a href="/Football/index.php/Soccer/team/<?=$game['teams'][1]?>"><?=$team_names[$game['teams'][1]]?></a></td>
 </tr>
