...
<?php } ?>
<form enctype="multipart/form-data" method="post" action="/index.php/gallery/photos_add/<?=$album_name ?>">
  <div class="form-group">
    <input type="file" id="photo" name="photo" value="<?=set_value('photo_name');?>" autofocus>
  </div>
  <div class="form-group">
